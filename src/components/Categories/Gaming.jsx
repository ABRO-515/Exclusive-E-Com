...
import TotalGaming from "../../api/TotalGaming";
...
const searchGaming = (elem) => {
  ...
  const filteredGaming = TotalGaming.filter((elem)=> searchGaming(elem))
    ...
    return (
      <>
        ...
        <div className="flex gap-3 items-center" >
          ...
          <h3 className="text-red-500 font-[400] " >Our Gaming</h3>
        </div>
        <h1 className="font-bold pt-5 text-2xl lg:text-3xl" >Explore Our Gaming</h1>
      </div>
