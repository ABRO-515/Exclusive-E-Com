...
import TotalHeadphones from "../../api/TotalHeadphones";
...
const searchHeadphones = (elem) => {
  ...
  const filteredHeadphones = TotalHeadphones.filter((elem) => searchHeadphones(elem));
    ...
    <>
      ...
      <div className="our-products ml-4 md:ml-6 xl:ml-12 flex flex-col mt-3 ">
        <div className="flex gap-3 items-center" >
          ...
          <h3 className="text-red-500 font-[400] " >Our Headphones</h3>
        </div>
        <h1 className="font-bold pt-5 text-2xl lg:text-3xl" >Explore Our Headphones</h1>
      </div>
